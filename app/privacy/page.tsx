...
import { privacyContent } from '@/messages/privacy';
                ...
                >
                  ...
                  <VStack gap={3} align="stretch">
                    {s.content.map((para, pi) => {
                      ...
                      if (para.includes('\n')) {
                        return (
                          <Box key={pi} p={4} borderRadius="4px"
                      ...
                      /* CAPS paragraphs (liability / legal disclaimers) */
                      ...
                      return (
                        <Text key={pi} fontSize="13.5px" color="#4A5568" lineHeight="1.85" fontFamily="heading">
                          {para}
                        </Text>
                      );
                    })}
                    ...
                    {/* Bullet groups */}
                    {s.bullets?.map((group, gi) => (
                      <Box key={gi} mt={gi === 0 ? 1 : 4}>
                        {group[0] && (
                          <Text fontSize="12px" fontWeight="700" color="#0B1E3D" fontFamily="heading"
                        ...
                        <Box
                          pl={4}
                          borderLeft="2px solid #D8E2EE"
                          style={{ display: 'flex', flexDirection: 'column', gap: '6px' }}
                        >
                          {group.slice(1).map((item, ii) => (
                            <HStack key={ii} gap={2} align="start">
                              <Text fontSize="13px" color="#1F6FEA" mt="2px" flexShrink={0} lineHeight={1}>
                                ›
                              </Text>
                              <Text fontSize="13px" color="#4A5568" lineHeight="1.7" fontFamily="heading">
                                {item}
                              </Text>
                            </HStack>
                          ))}
