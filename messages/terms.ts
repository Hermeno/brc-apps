...
const en: TermsContent = {
  ...
  intro: 'Please read these Terms of Service carefully before using the Verliks platform. By accessing or using our services, you agree to be bound by these terms.',
  sections: [
    {
      id: 's1',
    ...
    },
    {
      ...
      content: [
        ...
        'You are responsible for all activity that occurs under your account, whether or not authorized by you. You must notify Verliks immediately at support@verliks.com if you suspect any unauthorized access to or use of your account.',
    ...
    },
    {
      ...
      content: [
        ...
        'You may also terminate your own account at any time by contacting support@verliks.com. Termination does not relieve you of obligations incurred prior to termination, including payment obligations, indemnification obligations, and compliance with the arbitration agreement.',
      ],
    },
    {
      id: 's41',
    ...
    },
    {
      ...
      content: [
        ...
        'Verliks — Customer Support\nEmail: support@verliks.com\nWebsite: https://verliks.com\nResponse time: We aim to respond to all inquiries within 2 business days.',
        'For legal notices, including notices related to arbitration, please send written correspondence to: support@verliks.com with the subject line "Legal Notice."',
      ],
    },
  ],
};
...
const pt: TermsContent = {
  ...
  intro: 'Por favor, leia estes Termos de Serviço atentamente antes de usar a plataforma Verliks. Ao acessar ou usar nossos serviços, você concorda em estar vinculado a estes termos.',
  sections: [
    {
      id: 's1',
      title: '1. Aceitação dos Termos',
      content: [
        'Ao criar uma conta, acessar ou usar a plataforma Verliks ("Plataforma"), site ou quaisquer serviços relacionados (coletivamente, "Serviços"), você concorda em estar legalmente vinculado a estes Termos de Serviço ("Termos"), à nossa Política de Privacidade e a todas as outras políticas e diretrizes incorporadas por referência.',
    ...
    },
    {
      ...
      content: [
        ...
        'Estes Termos incluem disposições relativas a: (a) um acordo de arbitragem vinculante e renúncia de ação coletiva que afetam seus direitos legais em caso de disputa; (b) limitação de responsabilidade que restringe a responsabilidade legal da Verliks perante você; e (c) obrigações de indenização que exigem que você proteja a Verliks de determinadas reivindicações legais.',
    ...
    {
      id: 's3',
      title: '3. Natureza da Verliks',
      content: [
        'A Verliks é uma plataforma tecnológica de marketplace que conecta clientes que buscam serviços de limpeza com profissionais independentes. A Verliks NÃO é uma empresa de limpeza e não presta diretamente quaisquer serviços de limpeza.',
        'A Verliks disponibiliza a Plataforma como intermediária neutra para facilitar conexões, agendamentos, processamento de pagamentos e comunicação entre clientes e Faxineiras. A Verliks não supervisiona, direciona, controla nem monitora os serviços de limpeza efetivamente realizados por qualquer Faxineira.',
        'Nada nestes Termos ou na Plataforma deve ser interpretado como tornando a Verliks empregadora, coempregadora, agência de trabalho temporário ou empregadora conjunta de qualquer Faxineira. A relação entre a Verliks e as Faxineiras é de operadora de marketplace e prestadora de serviços independente.',
      ],
    },
    {
      id: 's4',
      ...
      content: [
        'Todas as Faxineiras que prestam serviços por meio da Plataforma Verliks são contratadas independentes, não empregadas, agentes ou representantes da Verliks. As Faxineiras têm o direito de prestar serviços para outros clientes e plataformas simultaneamente, e são livres para definir seus próprios horários, preços e condições de trabalho.',
        'As Faxineiras são as únicas responsáveis por determinar a forma, os meios e o método de prestação de seus serviços. A Verliks não dita como os serviços devem ser realizados, quais ferramentas ou materiais usar, nem como as Faxineiras gerenciam seu tempo.',
        'A Verliks não retém impostos, não oferece benefícios, compensação por acidente de trabalho, seguro-desemprego nem quaisquer outros benefícios relacionados ao emprego para as Faxineiras. Cada Faxineira é responsável pelo cumprimento de todas as leis federais, estaduais e locais aplicáveis que regem os contratados independentes.',
      ],
    },
    {
      id: 's5',
      ...
      content: [
        'Nenhuma relação de emprego, agência, parceria, joint venture, franquia ou fidúcia é criada entre a Verliks e qualquer Faxineira, ou entre a Verliks e qualquer Cliente, em virtude destes Termos ou do uso da Plataforma.',
        'As Faxineiras reconhecem e concordam que não têm direito a benefícios de desemprego, compensação por acidente de trabalho, seguro de saúde, benefícios de aposentadoria, férias remuneradas nem quaisquer outros benefícios de emprego provenientes da Verliks.',
        'Quaisquer representações em contrário por qualquer pessoa que afirme agir em nome da Verliks são não autorizadas e nulas. Se qualquer autoridade governamental ou tribunal determinar que uma Faxineira é empregada da Verliks, tal determinação não afetará retroativamente os direitos e obrigações estabelecidos nestes Termos.',
      ],
    },
    {
      id: 's6',
      ...
      content: [
        'Os Clientes são os únicos responsáveis por avaliar, selecionar e contratar Faxineiras por meio da Plataforma. A Verliks não endossa, recomenda nem garante nenhuma Faxineira específica. A decisão de contratar uma Faxineira específica é inteiramente de responsabilidade e risco do Cliente.',
    ...
    },
    {
      ...
      content: [
        ...
        'As Faxineiras são responsáveis pelo pagamento de todos os impostos de renda federais, estaduais e locais, impostos sobre o trabalho autônomo e quaisquer outros impostos decorrentes da renda obtida por meio da Plataforma. A Verliks não reterá quaisquer impostos em nome das Faxineiras.',
    ...
    },
    {
      ...
      content: [
        'A Verliks não garante, representa nem assegura de qualquer forma que: (a) as Faxineiras receberão qualquer número específico de leads, solicitações de serviço ou reservas; (b) as Faxineiras ganharão qualquer valor específico de renda ou receita; (c) os Clientes encontrarão Faxineiras disponíveis em sua área no horário desejado; (d) o uso da Plataforma resultará em crescimento de negócios ou aumento de receita para as Faxineiras.',
        'A disponibilidade de leads e reservas depende de muitos fatores fora do controle da Verliks, incluindo demanda geográfica, variações sazonais, concorrência entre Faxineiras e comportamento dos clientes. O desempenho passado na Plataforma não garante resultados futuros.',
    ...
    },
    {
      ...
      content: [
        'A Verliks utiliza algoritmos e sistemas proprietários para distribuir leads e conectar clientes com Faxineiras. A distribuição de leads pode levar em conta fatores incluindo, mas não se limitando a: proximidade geográfica, avaliação e comentários da Faxineira, nível de assinatura, taxa de resposta, taxa de conclusão de reservas, disponibilidade e indicadores de qualidade.',
        'A Verliks reserva-se o direito de modificar seus algoritmos de distribuição de leads a qualquer momento sem aviso prévio. A Verliks não garante distribuição igual ou proporcional de leads entre as Faxineiras.',
    ...
    },
    {
      ...
      content: [
        ...
        'A Verliks coleta o pagamento dos Clientes no momento da confirmação da reserva. Os fundos são mantidos com segurança e liberados para as Faxineiras após a conclusão bem-sucedida do serviço, sujeito a quaisquer taxas aplicáveis e ao período de resolução de disputas.',
        'Você autoriza a Verliks e seus processadores de pagamento a cobrar o método de pagamento cadastrado por todos os valores devidos. Se o pagamento não puder ser processado, seu acesso à Plataforma poderá ser suspenso até que o pagamento seja resolvido.',
      ],
    },
    {
      id: 's11',
      ...
      content: [
        'A Verliks cobra taxas pelo uso da Plataforma, que podem incluir taxas de assinatura, taxas de lead, taxas de transação ou outras cobranças de serviço. As estruturas de taxas atuais estão disponíveis na Plataforma e podem variar por tipo de serviço, área geográfica e nível de assinatura.',
        'A Verliks reserva-se o direito de alterar suas taxas a qualquer momento. Para Faxineiras com assinaturas pagas, as alterações de taxas entrarão em vigor no próximo ciclo de faturamento com aviso prévio razoável. Para taxas baseadas em transações, as alterações podem entrar em vigor imediatamente após publicação na Plataforma.',
    ...
    },
    {
      ...
      content: [
        ...
        'Solicitações de reembolso devem ser enviadas pelos canais de suporte oficiais dentro de 72 horas da data do serviço ou do evento de cancelamento. A Verliks reserva-se o direito de aprovar ou negar solicitações de reembolso a seu exclusivo critério, com base na investigação das circunstâncias.',
      ],
    },
    {
      id: 's13',
      ...
      content: [
        'Quaisquer transações, acordos ou arranjos financeiros realizados entre Clientes e Faxineiras fora da Plataforma Verliks ("Transações Fora da Plataforma") são conduzidos inteiramente por conta e risco das partes envolvidas. A Verliks proíbe expressamente a solicitação de transações fora da plataforma para serviços originalmente encontrados na Plataforma.',
        'A Verliks não é responsável por qualquer perda, dano, fraude, falta de pagamento ou outros prejuízos decorrentes de Transações Fora da Plataforma. Tais transações não são cobertas por quaisquer programas de proteção, serviços de resolução de disputas ou garantias de pagamento da Verliks.',
        'Realizar Transações Fora da Plataforma em violação a estes Termos pode resultar em suspensão ou encerramento da conta. Se você souber de outro usuário tentando realizar Transações Fora da Plataforma, reporte isso imediatamente à Verliks.',
      ],
    },
    {
      id: 's14',
      ...
      content: [
        ...
        'Você é responsável por todas as atividades que ocorrem em sua conta, autorizadas ou não. Você deve notificar imediatamente a Verliks em support@verliks.com se suspeitar de qualquer acesso ou uso não autorizado de sua conta.',
    ...
    },
    {
      ...
      content: [
        'Os usuários podem enviar avaliações, classificações, fotos e outros conteúdos ("Conteúdo do Usuário") para a Plataforma. Ao enviar Conteúdo do Usuário, você concede à Verliks uma licença não exclusiva, isenta de royalties, mundial e perpétua para usar, exibir, reproduzir, modificar e distribuir tal conteúdo em conexão com a operação e promoção da Plataforma.',
        'A Verliks reserva-se o direito, mas não tem obrigação, de revisar, moderar, editar ou remover qualquer Conteúdo do Usuário que viole estes Termos ou seja de outra forma censurável, a exclusivo critério da Verliks. As avaliações devem refletir experiências genuínas e não podem ser incentivadas, fabricadas ou manipuladas.',
        'A Verliks não é responsável por qualquer Conteúdo do Usuário publicado na Plataforma e não endossa qualquer opinião expressa em Conteúdo do Usuário. Você é o único responsável por garantir que seu Conteúdo do Usuário não viole a lei aplicável, não infrinja direitos de terceiros nem constitua difamação.',
      ],
    },
    {
      id: 's17',
      ...
      content: [
        'A Verliks pode facilitar a verificação opcional de antecedentes para Faxineiras por meio de fornecedores de triagem de terceiros. As verificações de antecedentes não são obrigatórias e não constituem garantia, segurança ou endosso de qualquer Faxineira pela Verliks.',
        ...
        'Os Clientes devem exercer seu próprio julgamento independente ao selecionar uma Faxineira, independentemente do status de verificação. A Verliks não é responsável por quaisquer atos ou omissões das Faxineiras, independentemente de terem sido submetidas à triagem de antecedentes.',
      ],
    },
    {
      id: 's18',
      ...
      content: [
        'A Verliks não fornece seguro de responsabilidade civil, seguro contra danos à propriedade, seguro de compensação para trabalhadores nem qualquer outro tipo de cobertura de seguro para Clientes, Faxineiras ou qualquer propriedade associada a serviços prestados por meio da Plataforma.',
    ...
    },
    {
      ...
      content: [
        'A Verliks não verifica, investiga nem faz quaisquer representações a respeito do status migratório ou de autorização de trabalho de qualquer Faxineira ou outro usuário da Plataforma.',
        'É responsabilidade exclusiva de cada usuário garantir o cumprimento de todas as leis de imigração e trabalho aplicáveis. Os Clientes que desejam verificar a autorização de trabalho de uma Faxineira devem fazê-lo de forma independente por meio dos canais legais adequados. A Verliks não fornece aconselhamento jurídico sobre questões de imigração.',
        'A Verliks isenta expressamente qualquer responsabilidade decorrente do status migratório de qualquer Faxineira. Todos os usuários concordam em isentar a Verliks de quaisquer reclamações, penalidades ou responsabilidades decorrentes de violações da lei de imigração por qualquer parte.',
      ],
    },
    {
      id: 's20',
    ...
    },
    {
      ...
      content: [
        'A Plataforma Verliks pode incorporar inteligência artificial, aprendizado de máquina e sistemas de tomada de decisão automatizados para aprimorar recursos incluindo, mas não se limitando a: correspondência de leads, sugestões de preços, otimização de agendamentos, moderação de conteúdo e detecção de fraudes.',
        'Conteúdo, recomendações ou resultados gerados por IA podem conter erros, imprecisões ou omissões. Os usuários são responsáveis por verificar de forma independente qualquer informação gerada por sistemas de IA antes de agir com base nela. A Verliks não garante a precisão, integralidade ou confiabilidade do conteúdo gerado por IA.',
        'A Verliks reserva-se o direito de implementar, modificar ou remover sistemas automatizados a qualquer momento sem aviso prévio. Os usuários concordam com o uso de tais sistemas como parte da aceitação destes Termos.',
      ],
    },
    {
      id: 's22',
      ...
      content: [
        'A Plataforma Verliks está atualmente em fase beta ou de produto mínimo viável ("MVP") de desenvolvimento. Recursos, funcionalidades, preços e disponibilidade podem mudar significativamente e sem aviso prévio durante esta fase.',
        'Como produto beta, a Plataforma pode conter erros, falhas, riscos de perda de dados ou outros problemas não presentes em softwares totalmente lançados. A Verliks disponibiliza a Plataforma "no estado em que se encontra" durante a fase beta e não oferece garantias quanto à estabilidade, confiabilidade ou integralidade de qualquer recurso.',
        'Ao usar a Plataforma durante a fase beta, você reconhece essas limitações e concorda em reportar quaisquer problemas ou erros à equipe de suporte da Verliks. O feedback dos usuários durante esta fase é valioso e pode ser usado para melhorar a Plataforma.',
      ],
    },
    {
      id: 's23',
      ...
      content: [
        'A Verliks não garante que a Plataforma estará disponível em todos os momentos ou livre de interrupções. A Plataforma pode ficar indisponível devido a: (a) manutenção programada; (b) problemas técnicos ou interrupções não programadas; (c) eventos além do controle razoável da Verliks; (d) ações de fornecedores de serviços terceirizados.',
        'A Verliks envidará esforços comercialmente razoáveis para manter a disponibilidade da Plataforma e fornecer aviso prévio de manutenção programada quando praticável. No entanto, a Verliks não será responsável por quaisquer danos, perdas ou inconvenientes causados pela indisponibilidade da Plataforma.',
        'A Verliks reserva-se o direito de descontinuar, suspender ou modificar qualquer recurso da Plataforma a qualquer momento, com ou sem aviso.',
      ],
    },
    {
      id: 's24',
      ...
      content: [
        ...
        'A Verliks não é responsável pelos atos, omissões, políticas ou termos de qualquer provedor de serviços terceirizado. O uso de serviços de terceiros é regido pelos respectivos termos de serviço e políticas de privacidade, que você é responsável por revisar.',
        'A Verliks pode alterar, adicionar ou remover integrações de serviços de terceiros a qualquer momento. Alterações nos serviços de terceiros podem afetar a funcionalidade da Plataforma, e a Verliks não será responsável por tais impactos.',
      ],
    },
    {
      id: 's25',
      ...
      content: [
        'Sua privacidade é importante para a Verliks. A coleta, uso, armazenamento e divulgação de suas informações pessoais é regida pela nossa Política de Privacidade, incorporada a estes Termos por referência e disponível em verliks.com/privacy.',
        ...
        'A Verliks implementa medidas de segurança comercialmente razoáveis para proteger suas informações pessoais, mas não pode garantir segurança absoluta. Você reconhece que a transmissão de dados pela internet carrega riscos inerentes.',
      ],
    },
    {
      id: 's26',
      ...
      content: [
        'Todos os direitos de propriedade intelectual da Plataforma Verliks, incluindo, sem limitação: o nome Verliks, logotipo, marcas registradas, marcas de serviço, apresentação comercial, design do site, aplicativo móvel, código-fonte, algoritmos, bancos de dados, conteúdo e toda a documentação relacionada, são de propriedade da Verliks ou de seus licenciadores.',
        'Nada nestes Termos concede a você qualquer direito, título ou interesse na propriedade intelectual da Verliks. Você recebe uma licença limitada, não exclusiva, intransferível e revogável para usar a Plataforma exclusivamente para seus fins pretendidos, de acordo com estes Termos.',
        'Qualquer uso não autorizado, reprodução, modificação ou distribuição da propriedade intelectual da Verliks é estritamente proibido e pode resultar em responsabilidade civil e criminal. A Verliks monitora e aplica ativamente seus direitos de propriedade intelectual.',
      ],
    },
    {
      id: 's27',
    ...
    },
    {
      ...
      content: [
        ...
        'A Verliks pode emitir formulários fiscais (como o Formulário IRS 1099-K ou 1099-NEC) para Faxineiras que atendam aos limites aplicáveis, conforme exigido por lei. É responsabilidade de cada Faxineira manter registros precisos de renda obtida e despesas incorridas por meio da Plataforma.',
        'A Verliks recomenda que todos os usuários consultem um profissional fiscal qualificado sobre sua situação fiscal específica. A Verliks não fornece aconselhamento fiscal e não é responsável por qualquer obrigação fiscal, penalidades ou juros cobrados de qualquer usuário.',
      ],
    },
    {
      id: 's29',
      ...
      content: [
        ...
        'As Faxineiras reconhecem especificamente que são responsáveis pelo cumprimento de todas as leis aplicáveis a contratados independentes e pequenas empresas em sua jurisdição. A Verliks não é responsável por orientar os usuários sobre os requisitos legais em suas localidades específicas.',
        'A Verliks coopera com as autoridades policiais e regulatórias e pode divulgar informações sobre usuários quando exigido por lei ou ordem judicial. A Verliks também pode reportar atividades ilegais suspeitas às autoridades competentes.',
      ],
    },
    {
      id: 's30',
      ...
      content: [
        'A Verliks não é parte de disputas entre Clientes e Faxineiras a respeito da qualidade, integralidade, pontualidade ou qualquer outro aspecto dos serviços de limpeza. A Verliks não é obrigada a mediar ou resolver disputas entre usuários.',
        'Embora a Verliks possa, a seu exclusivo critério, tentar facilitar a resolução de disputas entre usuários como cortesia, tal assistência não cria qualquer obrigação, responsabilidade ou responsabilização para a Verliks. A resolução final de qualquer disputa é de responsabilidade das partes envolvidas.',
        'Os usuários concordam em isentar a Verliks e seus diretores, executivos, funcionários e agentes de quaisquer reclamações, demandas e danos de qualquer natureza decorrentes ou de qualquer forma relacionados a disputas entre usuários.',
      ],
    },
    {
      id: 's31',
    ...
    },
    {
      ...
      content: [
        ...
        'A Verliks reserva-se o direito, às suas próprias expensas, de assumir a defesa e controle exclusivos de qualquer questão sujeita a indenização por você, caso em que você concorda em cooperar plenamente com a defesa da Verliks.',
      ],
    },
    {
      id: 's34',
      ...
      content: [
        ...
        'Exceto para disputas qualificadas para tribunais de pequenas causas e certas disputas de propriedade intelectual, você e a Verliks concordam que qualquer disputa, controvérsia ou reclamação decorrente de ou relacionada a estes Termos ou ao seu uso da Plataforma será resolvida por arbitragem individual vinculante administrada pela American Arbitration Association ("AAA") sob suas Regras de Arbitragem ao Consumidor.',
    ...
    },
    {
      ...
      content: [
        ...
        'Nada nesta seção deve ser interpretado como limitando a capacidade da Verliks de buscar medida cautelar ou outro remédio equitativo em qualquer tribunal competente para proteger seus direitos de propriedade intelectual ou prevenir dano irreparável.',
      ],
    },
    {
      id: 's38',
      ...
      content: [
        ...
        'Não obstante o exposto, a Verliks pode buscar medida cautelar de emergência em qualquer tribunal competente para prevenir dano irreparável pendente de resolução de uma disputa.',
      ],
    },
    {
      id: 's39',
      ...
      content: [
        'A Verliks não será responsável por qualquer falha ou atraso no cumprimento de suas obrigações nos termos deste acordo se tal falha ou atraso for causado por eventos além de seu controle razoável, incluindo, mas não se limitando a: atos de Deus, desastres naturais, epidemias ou pandemias, guerra, terrorismo, distúrbios civis, ações governamentais, disputas trabalhistas, falhas de energia, interrupções de internet ou falhas de prestadores de serviços terceirizados.',
        'No caso de um evento de força maior, a Verliks empregará esforços comercialmente razoáveis para retomar as operações normais o mais rápido possível. A Verliks fornecerá notificação do evento de força maior na medida razoavelmente praticável.',
        'Se um evento de força maior continuar por mais de sessenta (60) dias e afetar materialmente a capacidade da Verliks de fornecer os Serviços, qualquer uma das partes poderá rescindir este acordo mediante notificação por escrito, sem responsabilidade para a outra parte.',
      ],
    },
    {
      id: 's40',
      ...
      content: [
        'A Verliks reserva-se o direito de suspender, restringir ou encerrar permanentemente a conta de qualquer usuário e o acesso à Plataforma a qualquer momento, com ou sem aviso, por qualquer motivo, incluindo, mas não se limitando a: violação destes Termos, atividade fraudulenta, dano a outros usuários, requisitos de conformidade legal ou comportamento que a Verliks determine ser prejudicial à Plataforma ou a seus usuários.',
        'Após o encerramento de sua conta: (a) sua licença de uso da Plataforma cessa imediatamente; (b) você deve interromper todo uso da Plataforma; (c) a Verliks pode excluir os dados da sua conta de acordo com nossa Política de Privacidade; (d) quaisquer pagamentos pendentes podem ser retidos enquanto se investiga o motivo do encerramento.',
        'Você também pode encerrar sua própria conta a qualquer momento entrando em contato com support@verliks.com. O encerramento não o isenta de obrigações incorridas antes do encerramento, incluindo obrigações de pagamento, obrigações de indenização e conformidade com o acordo de arbitragem.',
      ],
    },
    {
      id: 's41',
      ...
      content: [
        'A Verliks reserva-se o direito de modificar, alterar ou atualizar estes Termos a qualquer momento. Quando houver alterações, a Verliks atualizará a data de "Última atualização" no topo deste documento e, para alterações relevantes, fornecerá aviso pela Plataforma, por e-mail ou por outros meios razoáveis.',
        ...
        'Para alterações significativas que afetem materialmente seus direitos, a Verliks envidará esforços para fornecer pelo menos 30 dias de aviso prévio. No entanto, alterações exigidas por lei podem entrar em vigor imediatamente.',
      ],
    },
    {
      id: 's42',
    ...
    },
    {
      ...
      content: [
        'A falha da Verliks em fazer cumprir qualquer direito ou disposição destes Termos a qualquer momento não deve ser interpretada como renúncia a tal direito ou disposição. Qualquer renúncia a qualquer disposição destes Termos só será eficaz se feita por escrito e assinada por um representante autorizado da Verliks.',
        'A renúncia a qualquer violação ou inadimplência específica não opera como renúncia a qualquer violação ou inadimplência subsequente da mesma ou de qualquer outra disposição. Os direitos e recursos da Verliks nos termos deste acordo são cumulativos e não excludentes de quaisquer outros direitos ou recursos que a Verliks possa ter perante a lei ou em equidade.',
        'Nenhuma ação ou inação da Verliks deve ser interpretada como acordo para modificar ou renunciar a qualquer direito ou obrigação nos termos deste acordo.',
      ],
    },
    {
      id: 's44',
      title: '44. Cessão',
      content: [
        'Você não pode ceder, transferir, delegar ou sublicenciar seus direitos ou obrigações nos termos deste acordo, total ou parcialmente, sem o consentimento prévio por escrito da Verliks. Qualquer cessão presumida em violação a esta seção é nula e sem efeito.',
        'A Verliks pode ceder ou transferir livremente estes Termos, ou quaisquer direitos ou obrigações aqui previstos, sem restrição e sem seu consentimento prévio, inclusive em conexão com uma fusão, aquisição, reorganização corporativa, venda de todos ou substancialmente todos os ativos da Verliks, ou por operação de lei.',
        'No caso de qualquer cessão permitida pela Verliks, o cessionário assumirá todos os direitos e obrigações nos termos deste acordo. Você será notificado de qualquer cessão relevante que afete seus direitos.',
      ],
    },
    {
      id: 's45',
      ...
      content: [
        'Estes Termos, juntamente com a Política de Privacidade, Política de Reembolso e quaisquer outras políticas, diretrizes ou termos suplementares incorporados por referência, constituem o acordo integral entre você e a Verliks com relação ao seu uso da Plataforma, e substituem todos os acordos, entendimentos, negociações e discussões anteriores e contemporâneos, orais ou escritos, entre as partes.',
    ...
    },
    {
      ...
      content: [
        ...
        'Verliks — Suporte ao Cliente\nE-mail: support@verliks.com\nSite: https://verliks.com\nTempo de resposta: Visamos responder a todas as consultas em até 2 dias úteis.',
        'Para notificações legais, incluindo notificações relacionadas a arbitragem, envie correspondência por escrito para: support@verliks.com com o assunto "Aviso Legal".',
      ],
    },
  ],
};
