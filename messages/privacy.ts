...
const en: PrivacyContent = {
  ...
  intro: 'Verliks ("Verliks," "we," "our," or "us") respects your privacy and is committed to protecting your information. This Privacy Policy explains how we collect, use, disclose, store, protect, and process information when you use our platform, website, applications, communications, and related services. By accessing or using the platform, you agree to this Privacy Policy and our Terms of Service.',
  sections: [
    {
      id: 'p1',
      title: '1. Nature of the Platform',
      content: [
        'Verliks is a technology marketplace platform that connects independent cleaning professionals with customers seeking cleaning-related services.',
        'Verliks does not directly provide cleaning services, does not employ service professionals, does not supervise services performed, does not guarantee service quality, and does not assume responsibility for services performed by independent professionals.',
    ...
    },
    {
      ...
      content: [
        'Verliks may use artificial intelligence, automated systems, chatbots, automated scheduling, automated lead routing, and automated communications as part of its platform operations.',
        ...
        'Verliks does not guarantee that automated systems will always provide accurate, uninterrupted, or error-free results. Any decisions made based on AI-generated outputs are the sole responsibility of the user.',
      ],
    },
    {
      id: 'p5',
      ...
      content: [
        'By submitting your contact information and creating an account, you expressly consent to receive SMS messages, phone calls, automated calls, AI-assisted communications, appointment reminders, operational notifications, and marketing communications from Verliks and its authorized partners.',
    ...
    },
    {
      ...
      content: [
        'All professionals using Verliks operate as independent contractors. Verliks is not responsible for service execution, damages, losses, theft, injuries, disputes, misconduct, negligence, accidents, property damage, unsatisfactory work, or contractual disagreements between users and professionals.',
        'Verliks does not guarantee the licensing, insurance, legal status, certifications, background check results, service quality, or legal compliance of any professional using the platform.',
        'Users acknowledge that Verliks acts solely as a technology intermediary platform and that all decisions regarding the engagement of any professional are made at the user\'s own risk and discretion.',
      ],
    },
    {
      id: 'p7',
      ...
      content: [
        'Nothing within the platform or these policies creates an employment, partnership, agency, franchise, or joint venture relationship between Verliks and any professional or user.',
        'Professionals retain full control over their schedules, pricing, acceptance of work, tools, transportation, and all aspects of their business operations. Verliks does not direct or control the manner or means by which professionals perform their services.',
    ...
    },
    {
      ...
      content: [
        ...
        'Verliks is not responsible for banking failures, payment processor downtime, chargebacks, declined transactions, processing delays, or financial institution errors. Any issues with payment processing should be directed to the relevant payment processor.',
        'Verliks does not store full payment card numbers. All sensitive payment data is handled directly by our payment processor in accordance with PCI-DSS standards.',
      ],
    },
    {
      id: 'p9',
    ...
    },
    {
      ...
      content: [
        'Verliks does not guarantee uninterrupted availability of the platform. The platform may experience maintenance windows, downtime, delays, technical failures, cyberattacks, integration failures, or operational interruptions.',
        'Features may be changed, modified, suspended, or discontinued at any time without prior notice. Verliks shall not be liable for any losses or inconveniences caused by platform unavailability.',
        'Verliks will make commercially reasonable efforts to restore service during any outage and to provide advance notice of scheduled maintenance where practicable.',
      ],
    },
    {
      id: 'p11',
    ...
    },
    {
      ...
      content: [
        'Users agree to defend, indemnify, and hold harmless Verliks, its owners, operators, affiliates, employees, contractors, and partners from and against any claims, liabilities, damages, costs, and expenses (including reasonable attorneys\' fees) arising from:',
        ...
        'Verliks reserves the right to assume exclusive control of any matter subject to indemnification by you, in which case you agree to cooperate fully with Verliks\'s defense of such matter.',
      ],
    },
    {
      id: 'p14',
      ...
      content: [
        'Any dispute related to Verliks, its platform, services, or these policies shall be resolved through binding individual arbitration administered under the rules of the American Arbitration Association (AAA).',
    ...
    },
    {
      ...
      content: [
        ...
        'You may request deletion of your account and associated personal data at any time by contacting support@verliks.com. Note that some data may be retained after deletion where required by law or for legitimate business purposes.',
      ],
    },
    {
      id: 'p16',
      ...
      content: [
        ...
        'However, no platform can guarantee absolute security. If you believe your account has been compromised, please notify us immediately at support@verliks.com. We will investigate and take appropriate action promptly.',
      ],
    },
    {
      id: 'p17',
      ...
      content: [
        'Verliks reserves the right to suspend accounts, terminate access, remove content, reject users, or restrict platform activity at any time, with or without prior notice, for any reason including violation of these policies, fraudulent activity, or harm to other users.',
        'Upon termination, your right to use the platform ceases immediately. Verliks may delete your account data in accordance with our data retention practices. Pending payments may be withheld pending investigation of the reason for termination.',
        'You may also terminate your account at any time by contacting support@verliks.com. Termination does not relieve you of obligations incurred prior to termination.',
      ],
    },
    {
      id: 'p18',
      ...
      content: [
        ...
        'If you believe a child has provided us with personal information, please contact us immediately at support@verliks.com so we can take appropriate action.',
      ],
    },
    {
      id: 'p19',
      ...
      content: [
        'Verliks may update this Privacy Policy at any time to reflect changes in our practices, technologies, legal requirements, or other factors. The "Last updated" date at the top of this document will be revised accordingly.',
...
const pt: PrivacyContent = {
  ...
  intro: 'A Verliks ("Verliks", "nós", "nosso" ou "nos") respeita sua privacidade e está comprometida em proteger suas informações. Esta Política de Privacidade explica como coletamos, usamos, divulgamos, armazenamos, protegemos e processamos informações quando você usa nossa plataforma, site, aplicativos, comunicações e serviços relacionados. Ao acessar ou usar a plataforma, você concorda com esta Política de Privacidade e nossos Termos de Serviço.',
  sections: [
    {
      id: 'p1',
      title: '1. Natureza da Plataforma',
      content: [
        'A Verliks é uma plataforma tecnológica de marketplace que conecta profissionais de limpeza independentes a clientes que buscam serviços relacionados à limpeza.',
        'A Verliks não presta diretamente serviços de limpeza, não emprega profissionais de serviços, não supervisiona os serviços prestados, não garante a qualidade dos serviços e não assume responsabilidade pelos serviços realizados por profissionais independentes.',
    ...
    },
    {
      ...
      content: [
        'A Verliks pode utilizar inteligência artificial, sistemas automatizados, chatbots, agendamento automatizado, roteamento automatizado de leads e comunicações automatizadas como parte das operações de sua plataforma.',
        ...
        'A Verliks não garante que os sistemas automatizados sempre fornecerão resultados precisos, ininterruptos ou sem erros. Quaisquer decisões tomadas com base em resultados gerados por IA são de exclusiva responsabilidade do usuário.',
      ],
    },
    {
      id: 'p5',
    ...
    },
    {
      ...
      content: [
        'Todos os profissionais que usam a Verliks operam como contratados independentes. A Verliks não é responsável pela execução de serviços, danos, perdas, furtos, lesões, disputas, má conduta, negligência, acidentes, danos à propriedade, trabalho insatisfatório ou desacordos contratuais entre usuários e profissionais.',
        'A Verliks não garante o licenciamento, seguro, situação legal, certificações, resultados de verificação de antecedentes, qualidade do serviço ou conformidade legal de qualquer profissional que usa a plataforma.',
        'Os usuários reconhecem que a Verliks atua exclusivamente como plataforma intermediária tecnológica e que todas as decisões referentes à contratação de qualquer profissional são tomadas por conta e risco do usuário.',
      ],
    },
    {
      id: 'p7',
      ...
      content: [
        'Nada na plataforma ou nestas políticas cria um vínculo de emprego, parceria, agência, franquia ou joint venture entre a Verliks e qualquer profissional ou usuário.',
        'Os profissionais mantêm controle total sobre seus horários, preços, aceitação de trabalho, ferramentas, transporte e todos os aspectos de suas operações comerciais. A Verliks não direciona nem controla a forma ou os meios pelos quais os profissionais prestam seus serviços.',
    ...
    },
    {
      ...
      content: [
        ...
        'A Verliks não é responsável por falhas bancárias, indisponibilidade do processador de pagamentos, estornos, transações recusadas, atrasos no processamento ou erros de instituições financeiras. Qualquer problema com o processamento de pagamentos deve ser direcionado ao processador de pagamentos relevante.',
        'A Verliks não armazena números de cartão de pagamento completos. Todos os dados de pagamento sensíveis são tratados diretamente pelo nosso processador de pagamentos em conformidade com os padrões PCI-DSS.',
      ],
    },
    {
      id: 'p9',
    ...
    },
    {
      ...
      content: [
        'A Verliks não garante disponibilidade ininterrupta da plataforma. A plataforma pode passar por janelas de manutenção, interrupções, atrasos, falhas técnicas, ataques cibernéticos, falhas de integração ou interrupções operacionais.',
        'Os recursos podem ser alterados, modificados, suspensos ou descontinuados a qualquer momento sem aviso prévio. A Verliks não será responsável por perdas ou inconvenientes causados pela indisponibilidade da plataforma.',
        'A Verliks envidará esforços comercialmente razoáveis para restaurar o serviço durante qualquer interrupção e fornecer aviso prévio de manutenção programada quando for praticável.',
      ],
    },
    {
      id: 'p11',
    ...
    },
    {
      ...
      content: [
        'Os usuários concordam em defender, indenizar e isentar de responsabilidade a Verliks, seus proprietários, operadores, afiliados, funcionários, contratados e parceiros de e contra quaisquer reclamações, responsabilidades, danos, custos e despesas (incluindo honorários advocatícios razoáveis) decorrentes de:',
        ...
        'A Verliks reserva-se o direito de assumir o controle exclusivo de qualquer questão sujeita a indenização por você, caso em que você concorda em cooperar plenamente com a defesa da Verliks.',
      ],
    },
    {
      id: 'p14',
      ...
      content: [
        'Qualquer disputa relacionada à Verliks, sua plataforma, serviços ou estas políticas será resolvida por meio de arbitragem individual vinculante administrada sob as regras da American Arbitration Association (AAA).',
    ...
    },
    {
      ...
      content: [
        ...
        'Você pode solicitar a exclusão de sua conta e dos dados pessoais associados a qualquer momento entrando em contato com support@verliks.com. Observe que alguns dados podem ser retidos após a exclusão quando exigido por lei ou para fins comerciais legítimos.',
      ],
    },
    {
      id: 'p16',
      ...
      content: [
        ...
        'No entanto, nenhuma plataforma pode garantir segurança absoluta. Se você acreditar que sua conta foi comprometida, notifique-nos imediatamente em support@verliks.com. Investigaremos e tomaremos as medidas adequadas prontamente.',
      ],
    },
    {
      id: 'p17',
      ...
      content: [
        'A Verliks reserva-se o direito de suspender contas, encerrar acesso, remover conteúdo, rejeitar usuários ou restringir a atividade na plataforma a qualquer momento, com ou sem aviso prévio, por qualquer motivo, incluindo violação dessas políticas, atividade fraudulenta ou dano a outros usuários.',
        'Após o encerramento, seu direito de usar a plataforma cessa imediatamente. A Verliks pode excluir os dados da sua conta de acordo com nossas práticas de retenção de dados. Pagamentos pendentes podem ser retidos enquanto se investiga o motivo do encerramento.',
        'Você também pode encerrar sua conta a qualquer momento entrando em contato com support@verliks.com. O encerramento não o isenta de obrigações incorridas antes do encerramento.',
      ],
    },
    {
      id: 'p18',
      ...
      content: [
        ...
        'Se você acreditar que uma criança nos forneceu informações pessoais, entre em contato imediatamente com support@verliks.com para que possamos tomar as medidas adequadas.',
      ],
    },
    {
      id: 'p19',
      ...
      content: [
        'A Verliks pode atualizar esta Política de Privacidade a qualquer momento para refletir mudanças em nossas práticas, tecnologias, requisitos legais ou outros fatores. A data de "Última atualização" no topo deste documento será revisada de acordo.',
